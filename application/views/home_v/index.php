            ...
            <?php foreach ($slides as $key => $value) : ?>
                <?php if (strtotime($value->sharedAt) <= strtotime("now")) : ?>
                    <?php if ($value->allowButton) : ?>
                        ...
                        <?php endif ?>
                    <?php endif ?>
                    <div class="slide-item p_relative pt_200 pb_200">
                        ...
                        <div class="image-layer p_absolute" style="background-image:url(<?= $this->agent->is_mobile() ? get_picture("slides_v", $value->mobile_url) : get_picture("slides_v", $value->img_url) ?>)"></div>
